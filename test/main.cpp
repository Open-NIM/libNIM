...
int main(){
	...
	/* std::cout << (bool) lssm[0].send(NIM::Counter::RSTA) << "\n"; */

	/* std::cout << (uint32_t)lssm[0].send(NIM::Counter::GET2) << "\n"; */
	/* std::cout << (bool) lssm[0].send(NIM::Counter::RSTA) << "\n"; */
	/* std::cout << (uint32_t)lssm[0].send(NIM::Counter::GET1) << "\n"; */
	...
	/* serial::Serial t0{"/dev/ttyACM0", 115200}; */
